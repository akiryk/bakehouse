 ...
 * itself (see chapters/home/about/motion.ts) rather than the page script
 * moving it.
 *
 ...
 * its own last screen. home.script.ts's trailing hold(1) exists for the
...
import { DWELL_BEATS } from "../chapters/home/about/motion";
