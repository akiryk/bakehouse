 ...
 */
import { initPageEngine } from "./engine";
...
export async function initHomePage(): Promise<void> {
  const [{ PAGE }, introMotion, servicesMotion, timelineMotion] =
    await Promise.all([
      import("./home.script"),
      import("../chapters/home/intro/motion").then((m) => m.default),
      import("../chapters/home/services/motion").then((m) => m.default),
      import("../chapters/home/timeline/motion").then((m) => m.default),
    ]);
  ...
  if (shapesContainer) {
    const { initScrollShapes } =
      await import("../components/scroll-shapes/motion");
...
export async function initAboutPage(): Promise<void> {
  const [{ PAGE }, aboutMotion] = await Promise.all([
    import("./about.script"),
    import("../chapters/home/about/motion").then((m) => m.default),
  ]);
