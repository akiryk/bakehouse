 ...
 *
 * AUTHORING  (e.g. src/pages/home/motion-script.ts):
 *
 *   import { definePageScript, at, chapter, enter, exit } from "@components/page-system/motion-script";
 ...
 * "vh" unit suffixes in start/end strings (see components/scroll-engine/motion-script.ts for the pattern).
 */

import gsap from "gsap";
import type { GsapEase, Moment } from "../timeline/motion-script";
import type { ScheduledEvent } from "../beat-model/motion-script";
import { scroll } from "../scroll-engine/config";
