 ...
 * unreachable), not a feel value — same reasoning components/stage/motion-script.ts already
 ...
 * about/motion-script.ts's chapter() placement always matches this timeline's own
 ...
 * handling in components/scroll-engine/motion-script.ts. Under reduced motion, initPageEngine jumps every
